...
This public proof repository preserves the source and local verification evidence
originally submitted in [awards PR #669](https://github.com/TheJustinSunPrize/awards/pull/669)
at commit [`07ba342205e2dbd39be9eedabb39e0e1873b6393`](https://github.com/TheJustinSunPrize/awards/commit/07ba342205e2dbd39be9eedabb39e0e1873b6393).
The `JSP301.lean` bytes are unchanged. The repository was created later to follow
the awards maintainers' external-source submission format; see [PROVENANCE.md](PROVENANCE.md).
...
The replacement awards PR links to this repository and proposes a catalog-only
change. This proof repository does not edit candidate records, award records, or
recipient profiles. Maintainers may request additional checks.
...
in this source repository. The original awards repository's [software license](LICENSE)
and [content license](LICENSE-CONTENT) are retained for the copied files; third-party
